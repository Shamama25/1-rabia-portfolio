...
const Contact = () => {
  return (
    <div className="max-w-[1400px] mx-auto bg-background sm:py-20 p-5" id="contact">
                  ...
                  <div>
                    <div className="mt-2.5 relative">
                      <input
                        ...
                        className="w-full px-4 py-4 text-gray-700 placeholder-gray-500 bg-white border-2 border-gray-400 rounded-md focus:outline-none focus:border-accent transition-colors duration-300"
                      />
                    </div>
                  </div>
